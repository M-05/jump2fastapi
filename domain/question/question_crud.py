...
def get_question_list(
    ...
    if keyword:
        ...
        question_list = question_list \
            ...
            .outerjoin(sub_query, and_(
                sub_query.c.question_id == models.Question.id
                )) \
...
def create_question(
        db: Session, question_create: QuestionCreate, user: models.User
                    ):
...
def update_question(
        db: Session, db_question: models.Question,
...
def vote_question(
        db: Session, db_question: models.Question, db_user: models.User
        ):
